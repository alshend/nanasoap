 ...
 */
function nanasoap_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'nanasoap_content_width', 640 );
}
add_action( 'after_setup_theme', 'nanasoap_content_width', 0 );
 ...
 */
function nanasoap_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'nanasoap' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'nanasoap' ),
...
add_action( 'widgets_init', 'nanasoap_widgets_init' );
